...
public class ConnectorLauncher {
  ...
  public enum JiraConnectorConfigKey implements RuntimeConfigKey {
    ...
    TIMEZONE("TIMEZONE"),
    JIRA_ISSUE_URL_PREFIX("JIRA_ISSUE_URL_PREFIX"),
    /**
     * Mapping of client ids per project. Base64 encoded UTF-8 string to avoid escaping issues.
     */
    PROJECT_CLIENTS_MAP("PROJECT_CLIENTS_MAP");
