...
| DATA_DIR              | If set, the connector will use the directory as the location for storing data to keep track on the Jira issues it have synced. By default, WT Connector will create a temporary dir under `/tmp` as its data storage. |
